...
%[b, a] = butter(8, [f1, f2]*2/Fs); %8th order BPF
%[b, a] = cheby2(2, 30, [f1, f2]*2/Fs); %2nd order 30dB atten. BPF
%[b, a] = ellip(2, 3, 60,[f1, f2]*2/Fs);% 2nd order 3dB passband,60dB stopband
[b, a] = butter(8, [f1, f2]*2/Fs, 'stop'); %8th order BSF
%% Frequency response
