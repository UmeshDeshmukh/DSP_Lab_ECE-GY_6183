...
for n in range(0,LENGTH):
 ...
 r_index_prev = int(math.floor(r_index)) 
 r_index_next = r_index_prev + 1
 if r_index_next == buffer_len:
  r_index_next = 0 
 
 frac = r_index - r_index_prev
 
 y0 =  (1-frac)* buffer[r_index_prev] + (frac)* buffer[r_index_next]
